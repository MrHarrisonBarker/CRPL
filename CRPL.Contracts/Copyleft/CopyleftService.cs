...
namespace CRPL.Contracts.Copyleft
{
    public partial class CopyleftService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, CopyleftDeployment copyleftDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<CopyleftDeployment>().SendRequestAndWaitForReceiptAsync(copyleftDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, CopyleftDeployment copyleftDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<CopyleftDeployment>().SendRequestAsync(copyleftDeployment);
        }

        public static async Task<CopyleftService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, CopyleftDeployment copyleftDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, copyleftDeployment, cancellationTokenSource);
            return new CopyleftService(web3, receipt.ContractAddress);
        }
        ...
        public CopyleftService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
