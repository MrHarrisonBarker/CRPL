...
using Meta = iTextSharp.text.Meta;
...
public class When_Interacting_with_Standard_Contract
{
    ...
    // {
    //     var receipt = await new StandardService(BlockchainConnection.Web3(), ContractAddress).RegisterRequestAndWaitForReceiptAsync(new RegisterWithMetaFunction()
    //     {
